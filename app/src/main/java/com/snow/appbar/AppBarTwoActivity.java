...
import com.snow.appbar.databinding.ActivityAppbarTwoBinding;
 ...
 */
public class AppBarTwoActivity extends BaseActivity<ActivityAppbarTwoBinding> {
    @Override
    protected int getLayoutId() {
        return R.layout.activity_appbar_two;
    }
